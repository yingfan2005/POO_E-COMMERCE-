public class SistemaPedidos{
    public static void main(String[] args){
        ...
        if(res)
        {
            ...
            System.out.println("Preço: "+ pedido1.calcularTotal());
        }
        else
        {
        ...
        if(res)
        {
            ...
            System.out.println("Preço: "+ pedido2.calcularTotal());
        }
        else
        {
        ...
        if(res)
        {
            ...
            System.out.println("Preço: "+ pedido3.calcularTotal());
        }
        else
        {
            System.out.println("O pagamento do cliente "+ cliente2.getNome()+" não foi realizado com sucesso.");
        ...
        if(res)
        {
            ...
            System.out.println("Preço: "+ pedido4.calcularTotal());
        }
        else
        {
